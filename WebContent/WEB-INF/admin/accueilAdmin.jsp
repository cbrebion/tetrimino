...
<body>
	...
	<div class="container">
		...
		<p>
			<a class="waves-effect waves-light btn-large red darken-4" href="/tetrimino/listeTetriminos"><i class="material-icons left">view_list</i>Liste des tetriminos</a>
		</p>
		<p>
			<a class="waves-effect waves-light btn-large red darken-4" href="/tetrimino/listeJoueurs"><i class="material-icons left">list</i>Liste des joueurs</a>
		</p>
	</div>
