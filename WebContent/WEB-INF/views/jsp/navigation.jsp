	...
	<div class="nav-wrapper container">
		...
		<c:if test="${ !empty sessionScope.admin or !empty sessionScope.joueur }">
			<ul class="right hide-on-med-and-down">
				<li  <c:if test='${ uri.equals("/tetrimino/faq.xhtml") or uri.equals("/tetrimino/ajoutFAQ.xhtml") or uri.equals("/tetrimino/modifierFAQ.xhtml") }'>class="active"</c:if>>
					<a href="/tetrimino/faq.xhtml">FAQ</a>
				</li>
